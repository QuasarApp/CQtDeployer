...
- Добавлены значки поддержки для целей. теперь опция значка работает с целями, но не с пакетами.
- Добавлена поддержка управления файлами пользовательского перевода.
- Добавлена поддержка развертывания неисполняемых данных. (опция extraData)
...
- deb - Создать пакет deb для программы развертывания
