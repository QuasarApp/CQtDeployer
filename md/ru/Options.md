...
|  -qifOut [nameOfOutputInstallerFile.run] | Устанавливает имя выходного установщика qifw. Предупреждение: для установщика Windows автоматически добавляется суффикс exe.  |
