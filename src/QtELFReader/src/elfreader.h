...
class ELFREADER_SHARED_EXPORT ElfSectionHeader
{
public:
    QByteArray name;
    quint32 index;
...
class ELFREADER_SHARED_EXPORT ElfProgramHeader
{
public:
    quint32 name;
    quint32 type;
...
class ELFREADER_SHARED_EXPORT ElfData
{
public:
...
class ELFREADER_SHARED_EXPORT ElfReader
{
public:
